  ...
  + inversion H5... 
    ++ (* binary connective right *)
      ...
      apply checkEncodeCasesU in H7...
       (* by cases on C *)
      destruct C...
      { apply AppPARTENSORRightI in H8...
      ...
      { (*  OR *)
        apply AppTENSORPARRightI in H8...
        apply OLInPermutation' in H4...
        rewrite H4 in HisD'.
        rewrite H4...
        rewrite <- perm_takeit_2...  
      ...
      { (* impl *)
        apply AppTENSORPAREXCHRightI in H8...
     ...
     {  rewrite !secCEncode in H7.
        ...
        eapply ImpGen with (A:=x8) (B:=x9)...
        rewrite Permutation_cons_append...
        change [G] with ([]++[G]).
           eapply H with (j:=j) (m:=x1) ...
     
        LLExact H12.
          apply setK4CEncode in H4...
        srewrite H13...
       }
    ++ (* binary connective left *)
      ...
      { (* impl *)
        ...
        apply AppTENSORPAREXCHLeftI in H8...   
        rewrite H9 in H6.
