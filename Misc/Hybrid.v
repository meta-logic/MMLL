...
(****************************************************************
   ...
   New definitions/lemmas in February 2019
   - function var_notin
   ...
   - lemmas abst_app_inv, abst_app1, abst_app2,
     uniform_app_inv, uniform_app1, uniform_app2, abst_abs
   - properties of subst: subst_abst, subst_uniform, subst_abst_eq,
     subst_uniform_eq
     (subst_uniform is a key lemma)
